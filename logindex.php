      ...
      <div class="caption">
       ...
       <h3 class="card-title clearfix"><?php echo $row["medioTransporte"];  ?></h3>
        <div class="txt3 clearfix">
          ...
          <div class="right_side"><a href=<?php echo "reserve.php?idc=".$row["idCircuito"]; ?> class="btn btn-primary btn-lg"   >Reservar</a></div>
          
          <?php
          if (isset($_SESSION['Rol']) && $_SESSION['Rol']=="Administrador"   ){
          echo '<div class="left_side"><a href= deleteTour.php?idc='.$row["idCircuito"].' class="btn btn-danger btn-lg">Eliminar</a></div>';
          }
          ?>
